...
function Users({ data, setLocal, selectedData, selectedItems }) {
   ...
   return (
      <>
         <Module setmodule={setmodule} data={data} setLocal={setLocal} module={module} />
         <div className=" grid md:grid-cols-8 grid-cols-12 text-center  py-3 md:text-lg border-b border-b-gray-400">
            ...
            <span className="md:col-span-2 hidden md:block">{data.phoneNumber ? data.phoneNumber : '. . . . . . . . .'}</span>
