            ...
            <div className="flex flex-col gap-y-8 text-2xl p-12 bg-white shadow-lg rounded-lg ">
               ...
               <div className="flex flex-col gap-y-4">
                  <div className="flex gap-x-4">
                     ...
                     <input dir="ltr" className="bg-gray-400 pl-3 hover:border rounded-md shadow-2xl h-14 w-[600px]" type="text" onChange={emailHandler} />
                  </div>
               ...
               <div className="flex flex-col gap-y-4">
                  <div className="flex gap-x-4">
                     ...
                     <input dir='ltr' className="bg-gray-400 pl-3 hover:border rounded-md shadow-2xl h-14 w-[600px]" type="text" onChange={phoneNumberHandler} />
                  </div>
